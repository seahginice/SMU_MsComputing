...
knitr::opts_chunk$set(echo = TRUE, eval=TRUE, message=FALSE,warning=FALSE,fig.width=10,fig.height =8)
```
...
packages = c('tidyverse','tidyquant','tsibbledata','tsibble','feasts','timetk',
             'ggplot2', 'nycflights13','stats','lubridate','data.table','rmarkdown','knitr')
for (p in packages) {
